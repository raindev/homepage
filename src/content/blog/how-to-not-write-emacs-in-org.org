...
Whoa!  My first line of Emacs Lisp configuration and somehow I broke
my Emacs already and made it load the config again and again.  I
search the Internet for the error message in vain, went in frustration
to #emacs and cried for help.  I've been told that it looks like
=org-babel-load-file= needs something that hasn't been initialized
yet.  It makes sense, I thought.  With some guidance (thanks pjb!) I
made Emacs load the .org file later when .el file has already been
processed:
...
"~/.emacs.d/init.org")=.  No surprisingly, the same thing happened:
...
[[file:emacs-org-babel-load-file-debugger.png]]
...
amazing!  I had the source code of Emacs packages laying open before
me.
...
nothing was exported and that's why I've got =file-missing= error.
...
I've accidentally written the config to =init.el=.  I didn't!
...
[[file:emacs-org-recursive-reloading.jpg]]
